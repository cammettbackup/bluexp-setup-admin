...
summary: After you sign up to BlueXP, you can log in from the web-based console to start managing your data and storage infrastructure.
---
...
[.lead]
How users log in to BlueXP depends on the BlueXP deployment mode that you're using for your account.
