...
. If you're creating your first Working Environment, select *Add Working Environment* and follow the prompts. Otherwise, select the *Connector* drop-down and select *Add Connector*.
+
