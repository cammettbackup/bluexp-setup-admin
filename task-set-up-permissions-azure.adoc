...
include::_include/azure-set-up-service-principal.adoc[create-azure-ad-app]
...
include::_include/azure-set-up-service-principal.adoc[add-api-permissions]

.Get the application ID and directory ID for the application

include::_include/azure-set-up-service-principal.adoc[get-ids]

.Create a client secret

include::_include/azure-set-up-service-principal.adoc[create-secret]
...
include::_include/azure-set-up-service-principal.adoc[app]

.Assign the application to a role
 
include::_include/azure-set-up-service-principal.adoc[role]

.Add Windows Azure Service Management API permissions

include::_include/azure-set-up-service-principal.adoc[api]

.Get the application ID and directory ID for the application

include::_include/azure-set-up-service-principal.adoc[ids]

.Create a client secret

include::_include/azure-set-up-service-principal.adoc[secret]
