...
When new versions of the Connector software are available, they'll be posted to the NetApp Support Site. link:task-managing-connectors.html#upgrade-the-connector-when-using-private-mode[Learn how to upgrade the Connector].
...
link:task-prepare-private-mode.html#step-5-prepare-cloud-permissions[Learn how to prepare cloud permissions].
