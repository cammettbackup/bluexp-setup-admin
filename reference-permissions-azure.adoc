...
* link:task-prepare-private-mode.html#prepare-cloud-permissions[Set up permissions for private mode]
...
The "Microsoft.Storage/storageAccounts/delete" permission is no longer needed for Cloud Data Sense.
