...
** link:task-install-connector-on-prem.html#step-3-set-up-cloud-permissions[Set up cloud permissions for on-prem deployments]
...
. Set the https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/concept-storage-management.html[Capacity Management Mode^]
+
