---
sidebar: sidebar
permalink: task-install-azure-marketplace.html
...
[.lead]
Set up your networking, prepare Azure permissions, and then create a Connector in Azure from the Azure Marketplace.
...
Create the Connector directly from the Azure Marketplace.
...
After you create the Connector from the Azure Marketplace, you need to provide BlueXP with the permissions that you previously set up. Providing the permissions enables BlueXP to manage your data and storage infrastructure in Azure.
