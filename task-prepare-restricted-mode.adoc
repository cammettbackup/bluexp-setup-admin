...
* \https://cloudmanagerinfraprod.azurecr.io (not required in Azure Government regions)
* \https://occmclientinfragov.azurecr.us (only required in Azure Government regions)
