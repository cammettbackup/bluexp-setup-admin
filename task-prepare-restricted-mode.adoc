...
summary: You need to prepare your environment before you deploy BlueXP in restricted mode. For example, you should review host requirements, prepare networking, set up permissions, and more.
---
...
[.lead]
You need to prepare your environment before you deploy BlueXP in restricted mode. For example, you should review host requirements, prepare networking, set up permissions, and more.
