...
[NOTE]
====
* At this time, notifications are sent by email for the following BlueXP features and services: Connector, BlueXP copy and sync, BlueXP backup and recovery, BlueXP digital wallet, and BlueXP ransomware protection. Additional services will be added in future releases.
