...
summary: You should understand how BlueXP uses AWS credentials and permissions so that you can manage credentials for one or more AWS accounts. For example, you might want to learn about adding additional AWS credentials to BlueXP.
---
...
[.lead]
You should understand how BlueXP uses AWS credentials and permissions so that you can manage credentials for one or more AWS accounts. For example, you might want to learn about adding additional AWS credentials to BlueXP.
