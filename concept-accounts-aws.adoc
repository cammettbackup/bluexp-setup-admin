...
summary: Learn how BlueXP uses AWS credentials and permissions so that you can manage the credentials for one or more AWS accounts. For example, you might want to learn about adding additional AWS credentials to BlueXP.
---
...
[.lead]
Learn how BlueXP uses AWS credentials and permissions so that you can manage the credentials for one or more AWS accounts. For example, you might want to learn about adding additional AWS credentials to BlueXP.
