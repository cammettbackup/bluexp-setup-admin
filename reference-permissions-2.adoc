---
sidebar: sidebar
permalink: reference-permissions-2.html
...
BlueXP requires AWS permissions for the Connector and for individual services. Select a service below to view when permissions are required and to access a link for full details.
...
BlueXP requires Azure permissions for the Connector and for individual services. Select a service below to view when permissions are required and to access a link for full details.
...
BlueXP requires Google Cloud permissions for the Connector and for individual services. Select a service below to view when permissions are required and to access a link for full details.
