---
sidebar: sidebar
permalink: task-install-azure-bluexp-2.html
...
Set up permissions that enable BlueXP to authenticate with Azure and deploy the VM. BlueXP automatically sets up permissions for the Connector VM during deployment.
