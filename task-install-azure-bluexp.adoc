...
Create a custom role that you can assign to your Azure account or to an Azure AD service principal. BlueXP authenticates with Azure and uses these permissions to create the Connector instance on your behalf.
...
== Step 3: Set up an authentication method
